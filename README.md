...
<p align="center">
  <img src="./mdimg/client_OFF-500x665.png" style="max-width:20%"; alt="OFF Screen" txt="OFF Screen"/>
  <img src="./mdimg/client_ON-500x665.png" style="max-width:20%"; alt="ON Screen" txt="ON Screen"/>
  <img src="./mdimg/client_WAIT-500x665.png" style="max-width:20%"; alt="WAIT Screen" txt="WAIT Screen"/>
</p>
